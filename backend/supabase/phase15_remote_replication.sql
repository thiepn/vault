...
-- Direct Data API access stays intentionally closed; authenticated clients use
-- the validated RPC functions below. Explicit deny policies document this and
-- keep the RLS posture visible to security tooling.
