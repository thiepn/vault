...
/** Phase 12 browser workspace: A2-backed Markdown spatial canvases on the accepted Phase 1-11 foundation. */
    ...
    <div class="workspace" data-sidebar-open="false">
      ...
      <main class="main" aria-label="Markdown workspace">
        ...
        <section class="empty-state">
          ...
          <p>Build movable note, text and media cards, connect ideas, group regions, and preserve the spatial document through A2-backed Markdown persistence.</p>
