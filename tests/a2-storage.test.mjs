...
test('A2 schema adds canonical, background, conflict and collaboration-history stores', () => {
  assert.equal(SCHEMA_VERSION, 7);
  for (const store of ['entities','noteBodies','blobPayloads','migrationState','backgroundRuntime','remoteInbox','conflicts','collabHistoryOutbox']) {
